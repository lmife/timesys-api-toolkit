...
def get_manifest_info(manifest_token, sbom_format=None, sbom_version='2.3', file_format='JSON'):
...
def get_manifest_file(manifest_token, sbom_format=None, sbom_version='2.3', file_format='JSON'):
